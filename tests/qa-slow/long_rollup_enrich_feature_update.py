...
CONTEXT_NAME = "context_enrich_feature_update"
CONTEXT_CONFIG = {
...
SIGNAL_NAME = "signal_enrich_feature_update"
SIGNAL_CONFIG = {
...
SIGNAL_CONFIG_MODIFIED = {
    ...
    "enrich": {
        "enrichments": [
            ...
            {
                "enrichmentName": "strict_pp2",
                "foreignKey": ["intAttribute"],
                "missingLookupPolicy": "Reject",
                "contextName": CONTEXT_NAME,
                "contextAttributes": [
                    {"attributeName": "intAttribute1", "fillIn": 0},
                    {"attributeName": "doubleAttribute1", "fillIn": 0.0},
                ],
            },
        ]
    },
        ...
        "features": [
            {
                ...
                "attributes": ["intAttribute", "testUpdateAttribType1", "testUpdateNewAttrib"],
                "featureInterval": INTERVAL_MS,
            },
            {
                "featureName": "view4",
...
class TestRollupEnrichAndFeatureUpdate(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        setup_tenant_config()
    ...
    def test(self):
        ...
        expected = {
            ...
            "sum(intAttribute1)": [4, 3, 3],
            "min(intAttribute1)": [0, 0, 0],
            "max(intAttribute1)": [2, 3, 1],
