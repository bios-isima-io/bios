...
SIGNAL_NAME = "retroactive_rollup_recreate"
SIGNAL_CONFIG = {
...
class TestRetroactiveRollupRecreate(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        setup_tenant_config()
    ...
    def test(self):
        ...
        # revert back the rollup addition
        ...
        self.assertEqual(len(data_window.records), 12)
