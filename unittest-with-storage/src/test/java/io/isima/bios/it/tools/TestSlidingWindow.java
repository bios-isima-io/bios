...
public class TestSlidingWindow implements SlidingWindow {
  private final SummarizeRequest summarizeRequest;

  public TestSlidingWindow(SummarizeRequest summarizeRequest) {
    this.summarizeRequest = summarizeRequest;
  }

  @Override
  public long getSlideIntervalMillis() {
    return this.summarizeRequest.getInterval();
  }

  @Override
  public int getNumberOfWindowSlides() {
    return (int) (this.summarizeRequest.getHorizon() / this.summarizeRequest.getInterval());
  }
