 ...
 *
 * <p>biOS control plain has camel case naming convention (such as storeDefaultValue) although Java
 ...
 */
public class EnumStringifier<E extends Enum<E>> {
   ...
   * The constructor.
   *
   * <p>The constructor builds the conversion table from JSON (camel name) to Enum entry and the
   * table from enum to JSON (camel name).
   *
   * @param values Enum values. Values would be available by method <code>E.values()</code>
   */
  public EnumStringifier(E[] values) {
   ...
   */
  public E destringify(String value) {
    if (value == null) {
   ...
   */
  public String stringify(E entry) {
