...
import static io.isima.trino.bios.BiosClient.SKETCH_FUNCTION_SEPARATOR;
import static io.isima.trino.bios.BiosClient.VIRTUAL_PREFIX;
        ...
        implements ColumnHandle
{
    ...
    {
        return ((columnName.contains(SKETCH_FUNCTION_SEPARATOR)) &&
                BiosClient.isSketchFunction(getSketchFunction()));
    }

    public String getSketchFunction()
    {
        return columnName.split(SKETCH_FUNCTION_SEPARATOR)[0];
    }

    public String getSketchSource()
    {
        return columnName.split(SKETCH_FUNCTION_SEPARATOR, 2)[1];
    }
