...
public class BiosConfig
{
    ...
    private Integer contextQueryBatchSizeInRows;
    private String contextsToHide;
    private String signalsToHide;
    ...
    {
        return featureLagSeconds != null ? featureLagSeconds : 60L;
    }
    ...
    public BiosConfig setFeatureAlignmentSeconds(Long featureAlignmentSeconds)
    {
    ...
    {
        return contextCacheSeconds != null ? contextCacheSeconds : 60 * 60L;
    }
    ...
    public Integer getContextQueryBatchSizeInRows()
    {
        return contextQueryBatchSizeInRows != null ? contextQueryBatchSizeInRows : 1000;
    }

    @Config("bios.contextQueryBatchSizeInRows")
    public BiosConfig setContextQueryBatchSizeInRows(Integer contextQueryBatchSizeInRows)
    {
        this.contextQueryBatchSizeInRows = contextQueryBatchSizeInRows;
        return this;
    }

    public String getContextsToHide()
    {
        return contextsToHide != null ? contextsToHide : "_ip2geo";
    }

    @Config("bios.contextsToHide")
    public BiosConfig setContextsToHide(String contextsToHide)
    {
        this.contextsToHide = contextsToHide;
        return this;
    }

    public String getSignalsToHide()
    {
        return signalsToHide != null ? signalsToHide : "";
    }

    @Config("bios.signalsToHide")
    public BiosConfig setSignalsToHide(String signalsToHide)
    {
        this.signalsToHide = signalsToHide;
        return this;
    }
}
