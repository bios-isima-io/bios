...
public class OperatorProcessorTest {
  private Stack<ExpressionTreeNode> expressionStack;
  private OperatorProcessor operatorProcessor;
  private final String greaterOperator = ">";
  private final Token operatorToken = new Token(TokenType.OPERATOR, greaterOperator);

  @Before
  public void setUp() {
    expressionStack = new Stack<>();
    operatorProcessor = new OperatorProcessor(expressionStack);
  }
  ...
  @Test
  public void testOperatorProcessor() throws Exception {
    operatorProcessor.process(operatorToken);
