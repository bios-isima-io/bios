...
public class Ip2GeoStream implements IStreamProvider {
  private static final Logger logger = LoggerFactory.getLogger(Ip2GeoStream.class);

  private static final String DEFAULT_SCHEMA_JSON_FILE = "ip2geo_context.json";

  private StreamConfig ip2GeoContextStream;

  public Ip2GeoStream() {
    this(DEFAULT_SCHEMA_JSON_FILE);
  }

  Ip2GeoStream(String schemaJsonFile) {
