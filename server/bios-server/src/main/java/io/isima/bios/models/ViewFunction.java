...
/** Enum which lists the view functions that are supported. */
public enum ViewFunction {
   ...
   * @return An {@link ViewFunction} entry.
   * @throws IllegalArgumentException when input string does not match any ActionType names.
   */
  @JsonCreator
  public static ViewFunction forValue(String value) {
    try {
      return ViewFunction.valueOf(value.toUpperCase());
