...
public class TenantAlreadyExistsException extends TenantException {
  ...
  public TenantAlreadyExistsException() {
    super(AdminError.TENANT_ALREADY_EXISTS);
  }

  public TenantAlreadyExistsException(String message) {
    super(AdminError.TENANT_ALREADY_EXISTS, message);
  }

  public TenantAlreadyExistsException(String tenant, String additionalMessage) {
    super(AdminError.TENANT_ALREADY_EXISTS, tenant + ": " + additionalMessage);
  }
}
