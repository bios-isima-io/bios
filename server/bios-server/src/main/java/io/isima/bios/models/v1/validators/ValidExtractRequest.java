...
@Retention(RUNTIME)
@Constraint(validatedBy = ExtractRequestValidator.class)
public @interface ValidExtractRequest {
  /**
   * Method to return constraint violation message.
   *
   * @return default template string for violation message
   */
  String message() default "{io.isima.bios.models.v1.validators.validextractrequest}";
