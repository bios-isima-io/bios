...
public class OpeningParenthesisProcessor implements TokenProcessor {

  private final Stack<ExpressionTreeNode> expressionStack;

  public OpeningParenthesisProcessor(Stack<ExpressionTreeNode> expressionStack) {
    this.expressionStack = expressionStack;
  }

  public void process(Token token) {
    expressionStack.push(new ScalarStringNode(token));
  }
}
