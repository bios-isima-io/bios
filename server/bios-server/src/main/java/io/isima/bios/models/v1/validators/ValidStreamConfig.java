...
@Retention(RUNTIME)
@Constraint(validatedBy = StreamConfigValidator.class)
public @interface ValidStreamConfig {
  /**
   * Method to return constraint violation message.
   *
   * @return default template string for violation message
   */
  String message() default "{io.isima.bios.models.v1.validators.validstreamconfig}";
