...
public class NoSuchStreamException extends StreamException {
  ...
  public NoSuchStreamException() {
    super(AdminError.STREAM_NOT_FOUND);
  }

  public NoSuchStreamException(String message) {
    super(AdminError.STREAM_NOT_FOUND, message);
  }

  public NoSuchStreamException(String tenant, String stream) {
    super(AdminError.STREAM_NOT_FOUND, tenant + "." + stream);
  }
}
