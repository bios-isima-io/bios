...
/**
 * This enum is meant to be used for indicating type of resource modification in an update REST API.
 */
public enum Operation {
  ...
  /**
   * Method to convert a string to Operation entry.
   *
   ...
   * @return An {@link Operation} entry.
   * @throws IllegalArgumentException when input string does not match any Operation names.
   */
  @JsonCreator
