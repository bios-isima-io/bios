...
public class InternalServerErrorException extends BiosServerException {
  private static final long serialVersionUID = -5582103144214608802L;
  ...
  public InternalServerErrorException(String message, Throwable t) {
    super(HttpResponseStatus.INTERNAL_SERVER_ERROR, message, t);
  }
}
