...
public class ContainsOperation implements Operation {

  public Object apply(Object first, Object second) throws UnexpectedValueException {
    String left = ComputationUtil.getValueAsString(first);
    String right = ComputationUtil.getValueAsString(second);
