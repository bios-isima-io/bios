...
public class CompositeProcessor implements TokenProcessor {
  private final Stack<ExpressionTreeNode> expressionStack;

  public CompositeProcessor(Stack<ExpressionTreeNode> expressionStack) {
    this.expressionStack = expressionStack;
  }

  public void process(Token token) {
    expressionStack.push(new CompositeExpressionNode(token));
  }
}
