...
public class ClientMetricsStream implements IStreamProvider {
  private static final Logger logger = LoggerFactory.getLogger(ClientMetricsStream.class);
  private static final String DEFAULT_SCHEMA_JSON_FILE = "client_metrics.json";

  private StreamConfig clientMetricsSignalStream;

  public ClientMetricsStream() {
    this(DEFAULT_SCHEMA_JSON_FILE);
  }

  ClientMetricsStream(String schemaJsonFile) {
    ...
    clientMetricsSignalStream = temp;
  }
  ...
  public StreamConfig getStreamConfig() {
    return clientMetricsSignalStream;
  }
}
