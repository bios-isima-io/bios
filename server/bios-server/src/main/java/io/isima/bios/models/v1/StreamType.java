...
public enum StreamType {
  ...
  /**
   * Method to convert a string to StreamType entry.
   *
   ...
   * @return An {@link StreamType} entry.
   * @throws IllegalArgumentException when input string does not match any StreamType names.
   */
  @JsonCreator
  ...
  // required for binding to @QueryParam
  ...
  /**
   * Returns if the entry indicates a primary type.
   *
   * <p>A primary type is a top level stream which is stored as an entry in the AdminStore
   */
  public boolean isPrimary() {
    return this == SIGNAL || this == CONTEXT || this == METRICS;
  }
}
