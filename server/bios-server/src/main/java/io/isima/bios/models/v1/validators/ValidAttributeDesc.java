...
@Retention(RUNTIME)
@Constraint(validatedBy = AttributeDescValidator.class)
public @interface ValidAttributeDesc {
  /**
   * Method to return constraint violation message.
   *
   * @return default template string for violation message
   */
  String message() default "{io.isima.bios.models.v1.validators.validattributedesc}";
